...
#     # test_mean, train_std, or test_std values that are already calculated for
#     # you. Which mean and std should you use to normalize the data?
#     test_data_tforms.append(transforms.Normalize((train_mean), (train_std)))
#
#     #######################################################################
#     #                          END OF YOUR CODE                           #
#     #######################################################################
...
class SimpleNet(nn.Module):
    ...
    def __init__(self, num_classes, droprate=0.5, rgb=False, verbose=False):
        ...
        # self.c = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=5, stride=1, padding=0, bias=False)
        # self.mp = nn.MaxPool2d(kernel_size=3, stride=2, padding=0)
        # self.r = nn.ReLU()
